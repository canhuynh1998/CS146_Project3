...
public class BinarySearchDeluxe {
    ...
    public static <Key> int firstIndexOf(Key[] a, Key key,
        ...
        //There won't be any index in front of lo
        ...
        while (lo <= hi) {
            ...
            if (compare < 0) {
                ...
                if (comparator.compare(a[mid - 1], a[mid]) == 0) {
                    hi = mid - 1;   // find the first index if duplicated
                } else {
                    return mid;
                }
            }
    ...
    public static <Key> int lastIndexOf(Key[] a, Key key,
        ...
        //There won't be any index after hi
        ...
        while (lo <= hi) {
            ...
            if (compare < 0) {
                ...
                if (comparator.compare(a[mid + 1], a[mid]) == 0) {
                    lo = mid + 1;   // find the last index if duplicated
                } else {
                    return mid;
                }
            }
